...
def main():
    ...
    ############################################################
    organism_json = "../SAFR-032/Bacillus_pumilus_SAFR-032.json" # "Acidianus_sp_DS-80.json"
    edge_filepath = "reaction_edges.json"
    json_outpath = "../SAFR-032/reaction_edges_SAFR-032.json"
    ...
    # edge_filepath = "reaction_edges.json" #"reaction_edges_ds-80.json"
    # outpath = "ds-80_reaction_compound_graph_with_attributes.pkl"
    # outpath = "kegg_reaction_compound_graph_without_attributes.pkl" #"ds-80_reaction_compound_graph_without_attributes.pkl"
    edge_filepath = "../SAFR-032/reaction_edges_SAFR-032.json"
    outpath = "../SAFR-032/SAFR-032_reaction_compound_graph_with_attributes.pkl"

    compound_dict = combine_all_compound_jsons_into_single_dict(compound_directory)
    reaction_dict = combine_all_reaction_jsons_into_single_dict(reaction_directory)
    attribute_dict = combine_compound_and_reaction_dicts(compound_dict,reaction_dict)
    G = create_networkx_graphs_from_edgelist_json(edge_filepath,attribute_dict=attribute_dict)
